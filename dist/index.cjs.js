...
var Icon$12 = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 512 568" }, props),
        React__default['default'].createElement("image", { width: "512", height: "568", href: "/images/logo.png" })));
};

var Icon$11 = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 225 225" }, props),
        React__default['default'].createElement("image", { width: "225", height: "225", href: "/images/logo-round.png" })));
};
...
var Icon$V = function (props) {
    ...
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 174 178" }, props),
        React__default['default'].createElement("image", { width: "174", height: "178", href: "/images/default-profile.png" })));
};
...
var Icon$H = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 80 80" }, props),
        React__default['default'].createElement("image", { width: "80", height: "80", href: "/images/ticket.png" })));
};

var Icon$G = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 48 48" }, props),
        React__default['default'].createElement("image", { width: "48", height: "48", href: "/images/ticket-round.png" })));
};
...
var getBackgroundColor = function (_a) {
    ...
    return theme.colors[variant === variants$3.SUBTLE ? "input" : (variant === variants$3.PRIMARY ? 'primaryBright' : "tertiary")];
};
...
var Icon$q = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 128 128" }, props),
        React__default['default'].createElement("image", { width: "128", height: "128", href: "/images/spin.png" })));
};
...
var Logo$2 = function (_a) {
    ...
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 474 127" }, props),
        React__default['default'].createElement("image", { width: "474", height: "127", href: "/images/logo-with-text.png" })));
};
...
var SocialLinks = function () { return (React__default['default'].createElement(Flex, null, socials.map(function (social, index) {
    ...
    if (social.items) {
        return (React__default['default'].createElement(Dropdown, { key: social.label, position: "top", target: React__default['default'].createElement(Icon, __assign({}, iconProps, { mr: mr })) }, social.items.map(function (item) { return (
        // <Link external key={item.label} href={item.href} aria-label={item.label} color="textSubtle">
        React__default['default'].createElement(Link, { external: true, key: item.label, href: "#", "aria-label": item.label, color: "textSubtle" }, item.label)); })));
    }
    return (
